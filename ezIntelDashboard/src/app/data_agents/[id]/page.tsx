...
export default () => {
  ...
  const fetchAgent = async () => {
    const docRef = doc(db, "data_agents", id);
  ...
  return (
    <DefaultLayout>
      <Breadcrumb
        rootName="Data Agents"
        rootPath="/data_agents"
      ...
      {agent && <LogTable logs={agent.data.logs || []} />}
    </DefaultLayout>
  );
};
      ...
      <div className="flex flex-col">
        <div className="grid grid-cols-3 rounded-sm bg-gray-2 dark:bg-meta-4 sm:grid-cols-5">
          ...
          <div className="hidden p-2.5 text-center sm:block xl:p-5">
            <h5 className="text-sm font-medium uppercase xsm:text-base">URL</h5>
          </div>
          <div className="hidden p-2.5 text-center sm:block xl:p-5">
            <h5 className="text-sm font-medium uppercase xsm:text-base">
              Body
          ...
          >
            ...
            */}
            ...
            <div className="flex items-center justify-center p-2.5 xl:p-5">
              <p className="text-black dark:text-white">{log.title}</p>
            </div>
            ...
            <div className="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
              <p className="text-meta-5">{log.url}</p>
            </div>
            <div className="hidden items-center justify-center p-2.5 sm:flex xl:p-5">
              <p>{log.body.length} chars</p>
            </div>
          </div>
        ))}
